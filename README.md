...
L'identification du BMP280 correspond à la lecture du registre ID.  
...
Le décorateur @app.route sert à associer une adresse URL à une fonction Python.
